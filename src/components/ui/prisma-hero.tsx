...
const PrismaHero = () => {
  return (
    <section id="hero" className="h-[100svh] w-full">
          ...
          <div className="grid grid-cols-12 items-end gap-4">
            <div className="col-span-12 lg:col-span-8">
              <h1
                ...
                style={{ color: PRIMARY }}
              >
                <WordsPullUp text="Kauã" showAsterisk />
              </h1>
            </div>
            ...
            <div className="col-span-12 flex flex-col gap-5 pb-2 lg:col-span-4 lg:pb-10">
              <motion.p
                ...
                style={{ lineHeight: 1.2, color: `${PRIMARY}B3` }}
              >
                Engenharia da Computação · Desenvolvedor Full Stack. Três sistemas em produção — CRM SaaS imobiliário, plataforma social de proteção e P&D em máquinas industriais. Do banco ao hardware.
              </motion.p>
